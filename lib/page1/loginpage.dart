...
import 'package:proj1/page2/signuppage.dart';
import 'package:proj1/page3/resetpass.dart';
        ...
        child: SafeArea(
          child: Center(
            child: Column(
             ...
             Image.asset('lib/images/oscode.png',
             width: 100,
             height: 100,
             ),
                ...
                children:[ 
                  Transform.scale(
                    ...
                    child: CupertinoSwitch(
                          ...
                          trackColor: isRememberMeChecked ? Colors.blue.withOpacity(0.5) : Colors.grey.withOpacity(0.5), // Change the active color to blue
                        ),
                  ),
